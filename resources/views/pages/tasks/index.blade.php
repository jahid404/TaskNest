...
@section('content')
    ...
    <div x-data="{ showFilters: {{ request()->hasAny(['search', 'status']) ? 'true' : 'false' }} }" class="mb-8">
        <!-- Action Toolbar -->
                ...
                <div class="flex flex-col gap-6 md:flex-row md:items-end">
                    <div class="flex flex-1 flex-col gap-4 md:flex-row md:items-end">
                        ...
                        <div class="w-full space-y-2 md:w-48">
                            ...
                            ]" :selected="request('status')" placeholder="Any Status"
                    ...
                    <div class="w-full space-y-2 md:w-auto">
                        ...
                        <button type="submit"
                            class="flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-brand-500 px-8 text-sm font-bold text-white shadow-lg shadow-brand-500/20 transition-all hover:bg-brand-600 hover:shadow-brand-500/40 md:w-auto">
                            Apply Filters
                        </button>
                    </div>
                </div>
                        ...
                        <div class="flex flex-col items-center justify-center">
                            @php
                                $statusIcon = match($task->status) {
                                    'completed' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />',
                                    'in_progress' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />',
                                    default => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />',
                                };
                            ...
                            @endphp
                            <svg class="h-16 w-16 {{ $statusColor }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                {!! $statusIcon !!}
                            </svg>
                        </div>
