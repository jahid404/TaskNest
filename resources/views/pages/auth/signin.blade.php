...
@section('content')
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        ...
                        {{-- Global Error --}}
                        @if ($errors->any())
                            <div class="mb-4 rounded-lg bg-error-50 p-4 text-sm text-error-500 dark:bg-error-500/10">
                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    <button type="submit"
                                        class="flex w-full items-center justify-center rounded-lg px-4 py-3 text-sm font-medium button-primary">
                                        Sign In
                                    </button>
                                </div>

                                @if (env('QUICK_LOGIN', false))
                                    @php
                                        $quickLogins = [
                                            [
                                                'label' => 'Admin',
                                    ...
                                    <div class="mt-6 border-t border-gray-200 pt-6 dark:border-gray-800">
                                        ...
                                        <div class="flex justify-center gap-x-4">
                                            @foreach ($quickLogins as $login)
                                                <button type="button"
                                                    @click="document.getElementById('email').value = '{{ $login['email'] }}'; document.getElementById('password').value = '{{ $login['password'] }}'; $el.closest('form').submit();"
                                                    class="flex h-10 items-center justify-center rounded-lg border border-gray-200 bg-gray-50/50 px-4 py-2 text-xs font-semibold text-gray-600 transition-all hover:border-brand-300 hover:bg-brand-50 hover:text-brand-600 dark:border-gray-700 dark:bg-gray-800/50 dark:text-gray-400 dark:hover:border-brand-500/50 dark:hover:bg-brand-500/10 dark:hover:text-brand-400">
                                                    {{ $login['label'] }}
                                                </button>
                                            @endforeach
                                        </div>
            ...
            <div class="bg-[#FBFAF9] relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    <x-common.common-grid-shape />
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="/" class="mb-4 block">
                            <span class="text-2xl lg:text-4xl font-bold text-gray-900 dark:text-white">Task<span
            ...
            <div class="fixed right-6 bottom-6 z-50">
                <button class="inline-flex size-14 items-center justify-center rounded-full button-primary"
